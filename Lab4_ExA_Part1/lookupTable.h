...
//    of the class to traverse through the list and  have acess to each
//    node.
...
public:
    ...
    //   In either case, the cursor goes to the off-list state.
    int remove(const int& keyA); // changed this to void
    ...
    // PROMISES: returns true if list is empty
    bool isEmpty()const;
    
    // PROMISES: returns the address of the key at the position index. Reminder: the index
